...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://khuranasahab09:<premiumstorehub>@premiumstorehub.ssb8a.mongodb.net/?retryWrites=true&w=majority&appName=Premiumstorehub")

DATABASE_NAME = environ.get('DATABASE_NAME', "PREMIUMSTOREHUB")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002214071155'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002214071155'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002214071155'))
